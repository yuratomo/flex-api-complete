...
call flexapi#class('Accordion', 'Container', ['IHistoryManagerClient, IFocusManagerComponent'], [
  ...
  \ flexapi#style(0, 'headerStyleName', 'String'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(1, 'kerning', 'Boolean'),
  \ flexapi#style(0, 'openEasingFunction', 'Function'),
...
call flexapi#class('Box', 'Container', [], [
  ...
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(0, 'horizontalScrollBarStyleName', 'String'),
  \ flexapi#style(0, 'paddingLeft', 'Number Length'),
  \ flexapi#style(0, 'right', 'String'),
...
call flexapi#class('DividedBox', 'Box', [], [
  ...
  \ flexapi#style(0, 'dividerAlpha', 'Number'),
  \ flexapi#style(1, 'dividerColor', 'uint Color'),
  \ flexapi#style(0, 'dividerSkin', 'Class'),
  \ flexapi#style(0, 'dividerThickness', 'Number Length'),
...
call flexapi#class('Form', 'Container', [], [
  ...
  \ flexapi#style(1, 'indicatorGap', 'Boolean'),
...
call flexapi#class('FormHeading', 'UIComponent', [], [
  ...
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(1, 'kerning', 'Boolean'),
  \ flexapi#style(1, 'labelWidth', 'Number Length'),
...
call flexapi#class('FormItem', 'Container', [], [
  ...
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(0, 'indicatorGap', 'Class'),
  \ flexapi#style(1, 'kerning', 'Boolean'),
  \ flexapi#style(1, 'labelWidth', 'Number Length'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(0, 'paddingLeft', 'Number Length'),
...
call flexapi#class('Panel', 'Container', [], [
  ...
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(0, 'horizontalScrollBarStyleName', 'String'),
  \ flexapi#style(1, 'modalTransparencyBlur', 'Number'),
  \ flexapi#style(1, 'modalTransparencyColor', 'uint Color'),
  \ flexapi#style(1, 'modalTransparencyDuration', 'Number Time'),
  \ flexapi#style(0, 'paddingBottom', 'Number Length'),
  \ flexapi#style(0, 'paddingLeft', 'Number Length'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(1, 'textAlign', 'String'),
  \ flexapi#style(0, 'titleStyleName', 'String'),
  \ flexapi#style(0, 'top', 'String'),
  \ flexapi#style(0, 'verticalCenter', 'String'),
  \ flexapi#style(0, 'verticalScrollBarStyleName', 'String'),
  \ flexapi#style(0, 'borderColor', 'uint Color'),
  \ flexapi#style(0, 'dropShadowVisible', 'Boolean'),
  \ flexapi#style(0, 'borderColor', 'uint Color'),
  \ flexapi#style(0, 'borderThicknessLeft', 'Number Length'),
  \ flexapi#style(0, 'borderThicknessRight', 'Number Length'),
  \ flexapi#style(0, 'borderThicknessTop', 'Number Length'),
  \ flexapi#style(0, 'cornerRadius', 'Number Length'),
  \ flexapi#style(1, 'dropShadowEnabled', 'Array Color'),
  \ flexapi#style(1, 'headerColors', 'Array Color'),
  \ flexapi#style(0, 'highlightAlphas', 'Array'),
  \ flexapi#style(0, 'roundedBottomCorners', 'Boolean'),
...
call flexapi#class('TabNavigator', 'ViewStack', ['IFocusManagerComponent'], [
  ...
  \ flexapi#style(0, 'focusRoundedCorners', 'String'),
  \ flexapi#style(1, 'fontAntiAliasType', 'String'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(1, 'kerning', 'Boolean'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(0, 'tabHeight', 'Number Length'),
  \ flexapi#style(0, 'tabOffset', 'Number Length'),
  \ flexapi#style(0, 'tabStyleName', 'String'),
...
call flexapi#class('TitleWindow', 'Panel', [], [
  ...
  \ flexapi#style(0, 'closeButtonDownSkin', 'Class'),
  \ flexapi#style(0, 'closeButtonOverSkin', 'Class'),
...
call flexapi#class('Button', 'UIComponent', [], [
  ...
  \ flexapi#style(1, 'direction', 'String'),
  \ flexapi#style(1, 'disabledColor', 'uint Color'),
  \ flexapi#style(0, 'disabledIcon', 'Class'),
  \ flexapi#style(0, 'disabledSkin', 'Class'),
  \ flexapi#style(0, 'downIcon', 'Class'),
  \ flexapi#style(0, 'downSkin', 'Class'),
  \ flexapi#style(0, 'emphasizedSkin', 'Class'),
  \ flexapi#style(1, 'errorColor', 'uint Color'),
  \ flexapi#style(0, 'focusRoundedCorners', 'Class'),
  \ flexapi#style(1, 'fontFamily', 'String'),
  \ flexapi#style(1, 'fontGridFitType', 'String'),
  \ flexapi#style(1, 'fontSharpness', 'Number'),
  \ flexapi#style(1, 'fontSize', 'Number Length'),
  ...
  \ flexapi#style(1, 'fontWeight', 'String'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(0, 'icon', 'Class'),
  \ flexapi#style(1, 'kerning', 'Boolean'),
  \ flexapi#style(0, 'labelVerticalOffset', 'Number Length'),
  \ flexapi#style(1, 'leading', 'Number Length'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(1, 'locale', 'String'),
  \ flexapi#style(0, 'overIcon', 'Class'),
  \ flexapi#style(0, 'overSkin', 'Class'),
  \ flexapi#style(0, 'paddingBottom', 'Number Length'),
  \ flexapi#style(0, 'paddingLeft', 'Number Length'),
  \ flexapi#style(0, 'paddingRight', 'Number Length'),
  \ flexapi#style(0, 'paddingTop', 'Number Length'),
  ...
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(0, 'selectedDisabledSkin', 'Class'),
  \ flexapi#style(0, 'selectedDownIcon', 'Class'),
  \ flexapi#style(0, 'selectedDownSkin', 'Class'),
  \ flexapi#style(0, 'selectedOverIcon', 'Class'),
  \ flexapi#style(0, 'selectedOverSkin', 'Class'),
  \ flexapi#style(0, 'selectedUpIcon', 'Class'),
  \ flexapi#style(0, 'selectedUpSkin', 'Class'),
  \ flexapi#style(0, 'skin', 'Class'),
  \ flexapi#style(1, 'textAlign', 'String'),
  \ flexapi#style(1, 'textDecoration', 'String'),
  \ flexapi#style(0, 'textFieldClass', 'Class'),
  \ flexapi#style(1, 'textIndent', 'Number Length'),
  ...
  \ flexapi#style(1, 'textSelectedColor', 'uint Color'),
  \ flexapi#style(0, 'top', 'String'),
  \ flexapi#style(0, 'upSkin', 'Class'),
  \ flexapi#style(0, 'verticalCenter', 'String'),
  \ flexapi#style(1, 'cornerRadius', 'uint Color'),
  \ flexapi#style(0, 'cornerRadius', 'Number Length'),
...
call flexapi#class('ButtonBar', 'NavBar', ['IFocusManagerComponent'], [
  ...
  \ flexapi#method(0, 'styleChanged(', 'styleProp:String)', 'void'),
  \ flexapi#method(0, 'drawFocus(', 'isFocused:Boolean)', 'void'),
  \ flexapi#style(0, 'buttonStyleName', 'String'),
  \ flexapi#style(0, 'buttonWidth', 'Number Length'),
  \ flexapi#style(1, 'color', 'uint Color'),
  \ flexapi#style(1, 'fontAntiAliasType', 'String'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(1, 'kerning', 'Boolean'),
...
call flexapi#class('ColorPicker', 'ComboBase', [], [
  ...
  \ flexapi#field(0, 'easingFunction', 'Function'),
  \ flexapi#style(0, 'closeEasingFunction', 'Function'),
  \ flexapi#style(1, 'color', 'uint Color'),
  \ flexapi#style(1, 'direction', 'String'),
  \ flexapi#style(1, 'disabledColor', 'uint Color'),
  \ flexapi#style(0, 'disabledSkin', 'Class'),
  ...
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(1, 'locale', 'String'),
  \ flexapi#style(0, 'openDuration', 'Number Time'),
  \ flexapi#style(0, 'openEasingFunction', 'Function'),
  \ flexapi#style(0, 'overSkin', 'Class'),
  \ flexapi#style(0, 'paddingLeft', 'Number Length'),
  \ flexapi#style(0, 'paddingRight', 'Number Length'),
  \ flexapi#style(0, 'paddingTop', 'Number Length'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(0, 'swatchPanelStyleName', 'String'),
  \ flexapi#style(1, 'textAlign', 'String'),
  \ flexapi#style(1, 'textDecoration', 'String'),
  \ flexapi#style(0, 'textFieldClass', 'Class'),
  \ flexapi#style(1, 'textIndent', 'Number Length'),
  \ flexapi#style(0, 'textInputClass', 'Class'),
...
call flexapi#class('ComboBase', 'UIComponent', ['IIMESupport, IFocusManagerComponent'], [
  ...
  \ flexapi#style(0, 'downSkin', 'Class'),
  \ flexapi#style(0, 'editableDisabledSkin', 'Class'),
  \ flexapi#style(0, 'editableDownSkin', 'Class'),
  \ flexapi#style(0, 'editableOverSkin', 'Class'),
  \ flexapi#style(0, 'editableSkin', 'Class'),
  \ flexapi#style(0, 'editableUpSkin', 'Class'),
  \ flexapi#style(1, 'errorColor', 'uint Color'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(0, 'textInputClass', 'Class'),
  \ flexapi#style(0, 'textInputStyleName', 'String'),
  \ flexapi#style(0, 'top', 'String'),
  \ flexapi#style(0, 'verticalCenter', 'String'),
  \ flexapi#style(1, 'contentBackgroundColor', 'uint Color'),
  \ flexapi#style(1, 'focusColor', 'uint Color'),
  \ flexapi#style(1, 'symbolColor', 'uint Color'),
  \ ])
...
call flexapi#class('ComboBox', 'ComboBase', [], [
  ...
  \ flexapi#method(0, 'close(', 'trigger:Event = null)', 'void'),
  \ flexapi#field(0, 'easingFunction', 'Function'),
  \ flexapi#style(0, 'arrowButtonWidth', 'Number Length'),
  \ flexapi#style(0, 'baseline', 'String'),
  ...
  \ flexapi#style(1, 'disabledColor', 'uint Color'),
  \ flexapi#style(0, 'disabledSkin', 'Class'),
  \ flexapi#style(0, 'dropdownStyleName', 'Class'),
  \ flexapi#style(0, 'focusRoundedCorners', 'Class'),
  \ flexapi#style(1, 'fontFamily', 'String'),
  \ flexapi#style(1, 'fontGridFitType', 'String'),
  \ flexapi#style(1, 'fontSharpness', 'Number'),
  ...
  \ flexapi#style(0, 'paddingTop', 'Number Length'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(1, 'selectionColor', 'uint Color'),
  \ flexapi#style(0, 'selectionDuration', 'uint Time'),
  \ flexapi#style(0, 'selectionEasingFunction', 'Function'),
  \ flexapi#style(0, 'skin', 'Class'),
  \ flexapi#style(1, 'textDecoration', 'String'),
  \ flexapi#style(0, 'textFieldClass', 'Class'),
  \ flexapi#style(1, 'textIndent', 'Number Length'),
  ...
  \ flexapi#style(0, 'cornerRadius', 'Number Length'),
  \ flexapi#style(1, 'disabledIconColor', 'uint Color'),
  \ flexapi#style(1, 'dropdownBorderColor', 'uint Color'),
  \ flexapi#style(0, 'fillAlphas', 'Array'),
  \ flexapi#style(0, 'fillColors', 'Array Color'),
  \ flexapi#style(0, 'highlightAlphas', 'Array'),
  \ flexapi#style(1, 'iconColor', 'uint Color'),
...
call flexapi#class('DataGrid', 'DataGridBase', ['IIMESupport'], [
  ...
  \ flexapi#style(0, 'columnResizeSkin', 'Class'),
  \ flexapi#style(0, 'defaultDataGridItemEditor', 'Class'),
  \ flexapi#style(0, 'defaultDataGridItemRenderer', 'Class'),
  \ flexapi#style(1, 'direction', 'String'),
  \ flexapi#style(0, 'headerDragProxyStyleName', 'String'),
  \ flexapi#style(0, 'headerSeparatorSkin', 'Class'),
  \ flexapi#style(0, 'headerStyleName', 'String'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(0, 'horizontalGridLines', 'Boolean'),
  \ flexapi#style(0, 'horizontalLockedSeparatorSkin', 'Class'),
  \ flexapi#style(0, 'horizontalScrollBarStyleName', 'String'),
  \ flexapi#style(0, 'horizontalSeparatorSkin', 'Class'),
  \ flexapi#style(1, 'kerning', 'Boolean'),
  \ flexapi#style(1, 'selectionColor', 'uint Color'),
  \ flexapi#style(1, 'selectionDisabledColor', 'uint Color'),
  \ flexapi#style(0, 'stretchCursor', 'Class'),
  \ flexapi#style(1, 'textAlign', 'String'),
  \ flexapi#style(0, 'verticalGridLines', 'Boolean'),
  \ flexapi#style(0, 'verticalLockedSeparatorSkin', 'Class'),
  \ flexapi#style(0, 'verticalScrollBarStyleName', 'String'),
  \ flexapi#style(0, 'verticalSeparatorSkin', 'Class'),
  \ flexapi#style(1, 'accentColor', 'uint Color'),
  \ flexapi#style(0, 'borderAlpha', 'Number'),
  \ flexapi#style(0, 'borderColor', 'uint Color'),
  \ flexapi#style(0, 'borderVisible', 'Boolean'),
  \ flexapi#style(1, 'chromeColor', 'uint Color'),
  \ flexapi#style(1, 'contentBackgroundAlpha', 'Number'),
  \ flexapi#style(1, 'contentBackgroundColor', 'uint Color'),
  \ flexapi#style(0, 'dropShadowVisible', 'Boolean'),
  \ flexapi#style(1, 'focusColor', 'uint Color'),
  \ flexapi#style(1, 'symbolColor', 'uint Color'),
  \ flexapi#style(0, 'backgroundAlpha', 'Number'),
...
call flexapi#class('DateChooser', 'UIComponent', ['IFocusManagerComponent, IFontContextComponent'], [
  ...
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(1, 'locale', 'String'),
  \ flexapi#style(0, 'nextMonthDisabledSkin', 'Class'),
  \ flexapi#style(0, 'nextMonthDownSkin', 'Class'),
  \ flexapi#style(0, 'nextMonthOverSkin', 'Class'),
  \ flexapi#style(0, 'nextMonthSkin', 'Class'),
  \ flexapi#style(0, 'nextMonthUpSkin', 'Class'),
  \ flexapi#style(0, 'nextYearDisabledSkin', 'Class'),
  \ flexapi#style(0, 'nextYearDownSkin', 'Class'),
  \ flexapi#style(0, 'nextYearOverSkin', 'Class'),
  \ flexapi#style(0, 'nextYearSkin', 'Class'),
  \ flexapi#style(0, 'nextYearUpSkin', 'Class'),
  \ flexapi#style(0, 'prevMonthDisabledSkin', 'Class'),
  \ flexapi#style(0, 'prevMonthDownSkin', 'Class'),
  \ flexapi#style(0, 'prevMonthOverSkin', 'Class'),
  \ flexapi#style(0, 'prevMonthSkin', 'Class'),
  \ flexapi#style(0, 'prevMonthUpSkin', 'Class'),
  \ flexapi#style(0, 'prevYearDisabledSkin', 'Class'),
  \ flexapi#style(0, 'prevYearDownSkin', 'Class'),
  \ flexapi#style(0, 'prevYearOverSkin', 'Class'),
  \ flexapi#style(0, 'prevYearSkin', 'Class'),
  \ flexapi#style(0, 'prevYearUpSkin', 'Class'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(0, 'rollOverIndicatorSkin', 'Class'),
  \ flexapi#style(1, 'selectionColor', 'uint Color'),
  \ flexapi#style(0, 'selectionIndicatorSkin', 'Class'),
  \ flexapi#style(1, 'textAlign', 'String'),
  \ flexapi#style(1, 'textDecoration', 'String'),
  \ flexapi#style(0, 'textFieldClass', 'Class'),
  \ flexapi#style(1, 'textIndent', 'Number Length'),
  \ flexapi#style(0, 'todayIndicatorSkin', 'Class'),
  \ flexapi#style(0, 'todayStyleName', 'String'),
  \ flexapi#style(0, 'top', 'String'),
  \ flexapi#style(0, 'weekDayStyleName', 'String'),
  \ flexapi#style(0, 'borderColor', 'uint Color'),
  \ flexapi#style(0, 'borderVisible', 'Boolean'),
  \ flexapi#style(1, 'contentBackgroundAlpha', 'uint Color'),
  \ flexapi#style(0, 'cornerRadius', 'Number Length'),
  \ flexapi#style(1, 'focusColor', 'uint Color'),
  \ flexapi#style(1, 'headerColors', 'Array Color'),
  \ flexapi#style(1, 'symbolColor', 'uint Color'),
  \ flexapi#style(1, 'todayColor', 'uint Color'),
  \ flexapi#style(0, 'backgroundColor', 'uint Color'),
  \ flexapi#style(0, 'borderColor', 'uint Color'),
  \ flexapi#style(0, 'borderThickness', 'Number Length'),
  \ flexapi#style(0, 'cornerRadius', 'Number Length'),
...
call flexapi#class('DateField', 'ComboBase', [], [
  ...
  \ flexapi#style(0, 'dateChooserStyleName', 'String'),
  \ flexapi#style(1, 'direction', 'String'),
  \ flexapi#style(1, 'disabledColor', 'uint Color'),
  \ flexapi#style(0, 'disabledSkin', 'Class'),
  \ flexapi#style(0, 'focusRoundedCorners', 'Class'),
...
call flexapi#class('HRule', 'UIComponent', [], [
  ...
  \ flexapi#style(1, 'strokeColor', 'uint Color'),
  \ flexapi#style(1, 'strokeWidth', 'Number Length'),
  \ flexapi#style(0, 'top', 'String'),
  \ ])
...
call flexapi#class('LinkBar', 'NavBar', [], [
  ...
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(1, 'selectionColor', 'uint Color'),
  \ flexapi#style(1, 'separatorColor', 'uint Color'),
  \ flexapi#style(0, 'separatorSkin', 'Class'),
  \ flexapi#style(1, 'separatorWidth', 'Number Length'),
  \ flexapi#style(1, 'textAlign', 'String'),
  \ flexapi#style(1, 'textSelectedColor', 'uint Color'),
  \ flexapi#style(0, 'top', 'String'),
  \ ])
...
call flexapi#class('LinkButton', 'Button', [], [
  ...
  \ flexapi#set(0, 'enabled', 'Boolean'),
  \ flexapi#style(1, 'direction', 'String'),
  \ flexapi#style(0, 'selectedDisabledIcon', 'Class'),
  \ flexapi#style(0, 'skin', 'Class'),
  \ flexapi#style(1, 'textSelectedColor', 'uint Color'),
  \ flexapi#style(0, 'top', 'String'),
  \ ])
...
call flexapi#class('Menu', 'List', ['IFocusManagerContainer'], [
  ...
  \ flexapi#style(0, 'baseline', 'String'),
  \ flexapi#style(0, 'branchIcon', 'Class'),
  \ flexapi#style(0, 'checkDisabledIcon', 'Class'),
  \ flexapi#style(0, 'checkIcon', 'Class'),
  \ flexapi#style(1, 'color', 'uint Color'),
  \ flexapi#style(0, 'horizontalScrollBarStyleName', 'String'),
  \ flexapi#style(1, 'letterSpacing', 'Number'),
  \ flexapi#style(0, 'paddingBottom', 'Number Length'),
  \ flexapi#style(0, 'radioIcon', 'Class'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(1, 'rollOverColor', 'uint Color'),
  \ flexapi#style(1, 'selectionColor', 'uint Color'),
  \ flexapi#style(1, 'selectionDisabledColor', 'uint Color'),
  \ flexapi#style(0, 'separatorSkin', 'Class'),
  \ flexapi#style(1, 'textAlign', 'String'),
...
call flexapi#class('MenuBar', 'UIComponent', ['IFocusManagerComponent'], [
  ...
  \ flexapi#style(1, 'fontWeight', 'String'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(0, 'itemOverSkin', 'Class'),
  \ flexapi#style(0, 'itemSkin', 'Class'),
  \ flexapi#style(0, 'itemUpSkin', 'Class'),
  \ flexapi#style(1, 'kerning', 'Boolean'),
  \ flexapi#style(1, 'leading', 'Number Length'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(1, 'locale', 'String'),
  \ flexapi#style(0, 'menuStyleName', 'String'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(1, 'selectionColor', 'uint Color'),
  \ flexapi#style(1, 'textAlign', 'String'),
  \ flexapi#style(1, 'textDecoration', 'String'),
...
call flexapi#class('NumericStepper', 'UIComponent', [], [
  ...
  \ flexapi#style(1, 'direction', 'String'),
  \ flexapi#style(1, 'disabledColor', 'uint Color'),
  \ flexapi#style(0, 'downArrowDisabledSkin', 'Class'),
  \ flexapi#style(0, 'downArrowDownSkin', 'Class'),
  \ flexapi#style(0, 'downArrowOverSkin', 'Class'),
  \ flexapi#style(0, 'downArrowSkin', 'Class'),
  \ flexapi#style(0, 'downArrowUpSkin', 'Class'),
  \ flexapi#style(1, 'errorColor', 'uint Color'),
  \ flexapi#style(0, 'focusRoundedCorners', 'Class'),
  \ flexapi#style(1, 'fontFamily', 'String'),
  \ flexapi#style(1, 'fontGridFitType', 'String'),
  ...
  \ flexapi#style(0, 'textInputClass', 'Class'),
  \ flexapi#style(0, 'top', 'String'),
  \ flexapi#style(0, 'upArrowDownSkin', 'Class'),
  \ flexapi#style(0, 'upArrowOverSkin', 'Class'),
  \ flexapi#style(0, 'upArrowSkin', 'Class'),
  \ flexapi#style(0, 'upArrowUpSkin', 'Class'),
  \ flexapi#style(0, 'verticalCenter', 'String'),
  \ flexapi#style(0, 'borderColor', 'uint Color'),
  \ flexapi#style(0, 'borderVisible', 'Boolean'),
  \ flexapi#style(1, 'contentBackgroundAlpha', 'uint Color'),
...
call flexapi#class('PopUpButton', 'Button ', [], [
  ...
  \ flexapi#style(0, 'openEasingFunction', 'Function'),
  \ flexapi#style(0, 'overIcon', 'Class'),
  \ flexapi#style(0, 'popUpGap', 'Number Length'),
  \ flexapi#style(0, 'popUpIcon', 'Class'),
  \ flexapi#style(0, 'popUpOverSkin', 'Class'),
  \ flexapi#style(0, 'popUpStyleName', 'String'),
  \ flexapi#style(0, 'repeatDelay', 'Number Time'),
  \ flexapi#style(1, 'textAlign', 'String'),
  \ flexapi#style(0, 'fillAlphas', 'Array'),
  \ flexapi#style(1, 'themeColor', 'uint Color'),
...
call flexapi#class('ProgressBar', 'UIComponent', ['IFontContextComponent'], [
  ...
  \ flexapi#style(1, 'fontWeight', 'String'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(0, 'indeterminateMoveInterval', 'Number'),
  \ flexapi#style(0, 'indeterminateSkin', 'Class'),
  \ flexapi#style(1, 'kerning', 'Boolean'),
  \ flexapi#style(1, 'labelWidth', 'Number Length'),
  \ flexapi#style(1, 'leading', 'Number Length'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(1, 'locale', 'String'),
  \ flexapi#style(0, 'maskSkin', 'Class'),
  \ flexapi#style(0, 'paddingLeft', 'Number Length'),
  \ flexapi#style(0, 'paddingRight', 'Number Length'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(1, 'textDecoration', 'String'),
  ...
  \ flexapi#style(1, 'textIndent', 'Number Length'),
  \ flexapi#style(0, 'top', 'String'),
  \ flexapi#style(0, 'trackSkin', 'Class'),
  \ flexapi#style(0, 'verticalCenter', 'String'),
  \ flexapi#style(0, 'borderColor', 'uint Color'),
  \ flexapi#style(1, 'themeColor', 'uint Color'),
...
call flexapi#class('VideoDisplay', 'UIComponent', [], [
  ...
  \ flexapi#style(0, 'borderColor', 'uint Color'),
  \ flexapi#style(0, 'borderVisible', 'Boolean'),
  \ flexapi#style(0, 'contentBackgroundColor', 'Boolean'),
  \ flexapi#style(0, 'backgroundColor', 'uint Color'),
  \ flexapi#style(1, 'backgroundDisabledColor', 'uint Color'),
  \ flexapi#style(0, 'backgroundImage', 'Object File'),
  \ flexapi#style(0, 'backgroundSize', 'String'),
...
call flexapi#class('ListBase', 'ScrollControlBase', [], [
  ...
  \ flexapi#style(1, 'selectionColor', 'uint Color'),
  \ flexapi#style(1, 'selectionDisabledColor', 'uint Color'),
  \ flexapi#style(0, 'selectionDuration', 'Number Time'),
  \ flexapi#style(0, 'selectionEasingFunction', 'Function'),
  \ flexapi#style(1, 'textAlign', 'String'),
  \ flexapi#style(1, 'textSelectedColor', 'uint Color'),
  \ flexapi#style(0, 'top', 'String'),
...
call flexapi#class('ScrollBar', 'UIComponent', [], [
  ...
  \ flexapi#style(0, 'downArrowUpSkin', 'Class'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(0, 'thumbIcon', 'Class'),
  \ flexapi#style(0, 'thumbOffset', 'Number'),
  \ flexapi#style(0, 'thumbOverSkin', 'Class'),
  \ flexapi#style(0, 'thumbSkin', 'Class'),
  \ flexapi#style(0, 'thumbUpSkin', 'Class'),
  \ flexapi#style(0, 'top', 'String'),
  \ flexapi#style(0, 'trackDownSkin', 'Class'),
  \ flexapi#style(0, 'trackOverSkin', 'Class'),
  \ flexapi#style(0, 'trackSkin', 'Class'),
  \ flexapi#style(0, 'trackUpSkin', 'Class'),
  \ flexapi#style(0, 'upArrowDisabledSkin', 'Class'),
  \ flexapi#style(0, 'upArrowDownSkin', 'Class'),
  \ flexapi#style(0, 'upArrowOverSkin', 'Class'),
  \ flexapi#style(0, 'upArrowSkin', 'Class'),
  \ flexapi#style(0, 'upArrowUpSkin', 'Class'),
...
call flexapi#class('Slider', 'UIComponent', [], [
  ...
  \ flexapi#field(0, 'easingFunction', 'Function'),
  \ flexapi#style(0, 'dataTipPrecision', 'int'),
  \ flexapi#style(0, 'dataTipStyleName', 'String'),
  \ flexapi#style(1, 'errorColor', 'uint Color'),
  \ flexapi#style(0, 'labelOffset', 'Number Length'),
  \ flexapi#style(0, 'labelStyleName', 'String'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(0, 'slideDuration', 'Number Time'),
  \ flexapi#style(0, 'slideEasingFunction', 'Function'),
  \ flexapi#style(0, 'thumbDisabledSkin', 'Class'),
  \ flexapi#style(0, 'thumbDownSkin', 'Class'),
  \ flexapi#style(0, 'thumbOffset', 'Number Length'),
  \ flexapi#style(0, 'thumbOverSkin', 'Class'),
  \ flexapi#style(0, 'thumbSkin', 'Class'),
  \ flexapi#style(0, 'thumbUpSkin', 'Class'),
  \ flexapi#style(0, 'tickColor', 'uint Color'),
  \ flexapi#style(0, 'tickLength', 'Number Length'),
  \ flexapi#style(0, 'tickOffset', 'Number Length'),
  \ flexapi#style(0, 'tickThickness', 'Number Length'),
  \ flexapi#style(0, 'top', 'String'),
  \ flexapi#style(0, 'trackMargin', 'Number Length'),
  \ flexapi#style(0, 'trackSkin', 'Class'),
  \ flexapi#style(0, 'verticalCenter', 'String'),
...
call flexapi#class('Tree', 'List', ['IIMESupport'], [
  ...
  \ flexapi#style(0, 'baseline', 'String'),
  \ flexapi#style(1, 'depthColors', 'Array Color'),
  \ flexapi#style(1, 'direction', 'String'),
  \ flexapi#style(0, 'disclosureOpenIcon', 'Class EmbeddedFile'),
  \ flexapi#style(0, 'dropIndicatorSkin', 'Class'),
  \ flexapi#style(0, 'folderOpenIcon', 'Class EmbeddedFile'),
  \ flexapi#style(1, 'fontAntiAliasType', 'String'),
  \ flexapi#style(1, 'kerning', 'Boolean'),
  \ flexapi#style(0, 'openEasingFunction', 'Function'),
  \ flexapi#style(0, 'paddingLeft', 'Number Length'),
...
call flexapi#class('Container', 'UIComponent', [], [
  ...
  \ flexapi#style(1, 'direction', 'String'),
  \ flexapi#style(1, 'disabledColor', 'uint Color'),
  \ flexapi#style(0, 'disabledOverlayAlpha', 'Number'),
  \ flexapi#style(1, 'errorColor', 'uint Color'),
  \ flexapi#style(1, 'fontFamily', 'String'),
  \ flexapi#style(1, 'fontGridFitType', 'String'),
  \ flexapi#style(1, 'fontSharpness', 'Number'),
  ...
  \ flexapi#style(0, 'backgroundImage', 'Object File'),
  \ flexapi#style(0, 'backgroundSize', 'String'),
  \ flexapi#style(1, 'barColor', 'uint Color'),
  \ flexapi#style(0, 'borderColor', 'uint Color'),
  \ flexapi#style(0, 'borderSides', 'String'),
  \ flexapi#style(0, 'borderThickness', 'Number Length'),
  \ flexapi#style(0, 'cornerRadius', 'Number Length'),
