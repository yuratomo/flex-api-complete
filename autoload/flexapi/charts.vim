...
call flexapi#class('AxisRenderer', 'DualStyleObject', ['IAxisRenderer'], [
  ...
  \ flexapi#field(0, 'text', 'String'),
  \ flexapi#style(1, 'axisTitleStyleName', 'String'),
  \ flexapi#style(0, 'baseline', 'String'),
  \ flexapi#style(0, 'canStagger', 'Boolean'),
  ...
  \ flexapi#style(0, 'labelAlign', 'String'),
  \ flexapi#style(0, 'labelGap', 'Number Length'),
  \ flexapi#style(0, 'labelRotation', 'Number'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(0, 'minorTickLength', 'Number Length'),
  \ flexapi#style(0, 'minorTickPlacement', 'String'),
  \ flexapi#style(0, 'minorTickStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(0, 'showLine', 'Boolean'),
  ...
  \ flexapi#style(0, 'tickPlacement', 'String'),
  \ flexapi#style(0, 'tickStroke', 'mx.graphics.IStroke'),
...
call flexapi#class('BarChart', 'CartesianChart', [], [
  ...
  \ flexapi#method(0, 'styleChanged(', 'styleProp:String)', 'void'),
  \ flexapi#style(0, 'baseline', 'String'),
  \ flexapi#style(0, 'maximumDataTipCount', 'int'),
  \ ])
...
call flexapi#class('BubbleChart', 'CartesianChart', [], [
  ...
  \ flexapi#set(0, 'moduleFactory', 'IFlexModuleFactory'),
  \ flexapi#method(0, 'styleChanged(', 'styleProp:String)', 'void'),
  \ flexapi#style(0, 'minRadius', 'Number Length'),
...
call flexapi#class('CandlestickChart', 'CartesianChart', [], [
  ...
  \ flexapi#set(0, 'moduleFactory', 'IFlexModuleFactory'),
  \ flexapi#method(0, 'styleChanged(', 'styleProp:String)', 'void'),
  \ flexapi#style(0, 'dataTipCalloutStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(0, 'maximumDataTipCount', 'int'),
  \ ])
...
call flexapi#class('GridLines', 'ChartElement', [], [
  ...
  \ flexapi#method(0, 'chartStateChanged(', 'oldState:uint, newState:uint)', 'void'),
  \ flexapi#style(0, 'horizontalAlternateFill', 'mx.graphics.IFill'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(0, 'horizontalFill', 'mx.graphics.IFill'),
  \ flexapi#style(0, 'horizontalOriginStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(0, 'horizontalShowOrigin', 'Boolean'),
  \ flexapi#style(0, 'horizontalStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(0, 'horizontalTickAligned', 'Boolean'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(0, 'verticalCenter', 'String'),
  \ flexapi#style(0, 'verticalFill', 'mx.graphics.IFill'),
  \ flexapi#style(0, 'verticalOriginStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(0, 'verticalShowOrigin', 'Boolean'),
  \ flexapi#style(0, 'verticalStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(0, 'verticalTickAligned', 'Boolean'),
  \ ])
...
call flexapi#class('Legend', 'UIComponent', ['IContainer'], [
  ...
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(1, 'markerWidth', 'Number Length'),
...
call flexapi#class('LegendItem', 'UIComponent', [], [
  ...
  \ flexapi#style(1, 'labelPlacement', 'String'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(1, 'letterSpacing', 'Number'),
  \ flexapi#style(1, 'markerHeight', 'Number Length'),
  \ flexapi#style(1, 'markerWidth', 'Number Length'),
  \ flexapi#style(0, 'paddingLeft', 'Number Length'),
...
call flexapi#class('PieChart', 'PolarChart', [], [
  ...
  \ flexapi#style(1, 'fontWeight', 'String'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(1, 'itemDisabledColor', 'uint Color'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(0, 'maximumDataTipCount', 'int'),
  \ flexapi#style(1, 'textDecoration', 'String'),
  \ flexapi#style(1, 'textIndent', 'Number Length'),
...
call flexapi#class('CartesianChart', 'ChartBase', [], [
  ...
  \ flexapi#style(1, 'fontThickness', 'Number'),
  \ flexapi#style(1, 'fontWeight', 'String'),
  \ flexapi#style(0, 'gridLinesStyleName', 'String'),
  \ flexapi#style(0, 'gutterBottom', 'Number Length'),
  \ flexapi#style(0, 'gutterLeft', 'Number Length'),
  \ flexapi#style(0, 'gutterRight', 'Number Length'),
  \ flexapi#style(0, 'gutterTop', 'Number Length'),
  \ flexapi#style(0, 'horizontalAxisStyleNames', 'Array'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(0, 'maximumDataTipCount', 'int'),
  \ flexapi#style(0, 'verticalAxisStyleNames', 'Boolean'),
  \ flexapi#style(1, 'textDecoration', 'String'),
  \ flexapi#style(1, 'textIndent', 'Number Length'),
  \ flexapi#style(0, 'top', 'String'),
...
call flexapi#class('ChartBase', 'UIComponent', ['IFocusManagerComponent'], [
  ...
  \ flexapi#style(1, 'color', 'uint Color'),
  \ flexapi#style(0, 'dataTipCalloutStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(0, 'dataTipRenderer', 'Class'),
  \ flexapi#style(1, 'disabledColor', 'uint Color'),
  \ flexapi#style(1, 'errorColor', 'uint Color'),
  \ flexapi#style(0, 'focusBlendMode', 'String'),
  \ flexapi#style(1, 'fontFamily', 'String'),
  ...
  \ flexapi#style(1, 'fontWeight', 'String'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(1, 'itemRollOverColor', 'uint Color'),
  \ flexapi#style(1, 'itemSelectionColor', 'uint Color'),
  \ flexapi#style(1, 'kerning', 'Boolean'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(0, 'maximumDataTipCount', 'int'),
  \ flexapi#style(0, 'paddingBottom', 'Number Length'),
...
call flexapi#class('AreaSeries', 'Series', ['IStackable2'], [
  ...
  \ flexapi#style(0, 'areaFill', 'mx.graphics.IFill'),
  \ flexapi#style(0, 'areaRenderer', 'mx.core.IFactory'),
  \ flexapi#style(0, 'areaStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(0, 'baseline', 'String'),
  \ flexapi#style(0, 'fills', 'Array'),
  \ flexapi#style(0, 'focusBlendMode', 'String'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(0, 'radius', 'Number Length'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(0, 'top', 'String'),
  \ flexapi#style(0, 'areaFill', 'mx.graphics.IFill'),
  \ flexapi#style(0, 'areaRenderer', 'mx.core.IFactory'),
...
call flexapi#class('BarSeries', 'Series', ['IStackable2, IBar'], [
  ...
  \ flexapi#style(1, 'kerning', 'Boolean'),
  \ flexapi#style(0, 'labelAlign', 'String'),
  \ flexapi#style(0, 'labelPosition', 'String'),
  \ flexapi#style(0, 'labelSizeLimit', 'Number'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(1, 'letterSpacing', 'Number'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(1, 'textAlign', 'String'),
...
call flexapi#class('CandlestickSeries', 'HLOCSeriesBase', [], [
  ...
  \ flexapi#method(0, 'stylesInitialized(', ')', 'void'),
  \ flexapi#method(0, 'styleChanged(', 'styleProp : String) : void', ''),
  \ flexapi#style(0, 'declineFill', 'mx.graphics.IFill'),
  \ flexapi#style(1, 'errorColor', 'uint Color'),
  \ flexapi#style(0, 'fills', 'Array'),
  \ flexapi#style(0, 'focusBlendMode', 'String'),
  \ flexapi#style(0, 'top', 'String'),
...
call flexapi#class('HLOCSeries', 'HLOCSeriesBase', [], [
  ...
  \ flexapi#set(0, 'moduleFactory', 'IFlexModuleFactory'),
  \ flexapi#style(0, 'closeTickStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(1, 'errorColor', 'uint Color'),
  \ flexapi#style(0, 'openTickStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(0, 'top', 'String'),
  \ flexapi#style(0, 'closeTickStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(1, 'errorColor', 'uint Color'),
...
call flexapi#class('LineSeries', 'Series', [], [
  ...
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(0, 'lineSegmentRenderer', 'mx.core.IFactory'),
  \ flexapi#style(0, 'lineStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(0, 'radius', 'Number Length'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(0, 'top', 'String'),
  \ flexapi#style(0, 'baseline', 'String'),
...
call flexapi#class('PieSeries', 'Series', [], [
  ...
  \ flexapi#get(0, 'data', 'Object'),
  \ flexapi#set(0, 'data', 'Object'),
  \ flexapi#style(0, 'calloutStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(1, 'color', 'uint Color'),
  \ flexapi#style(1, 'disabledColor', 'uint Color'),
  \ flexapi#style(1, 'errorColor', 'uint Color'),
  \ flexapi#style(0, 'focusBlendMode', 'String'),
  ...
  \ flexapi#style(1, 'fontWeight', 'String'),
  \ flexapi#style(0, 'horizontalCenter', 'String'),
  \ flexapi#style(0, 'insideLabelSizeLimit', 'Number'),
  \ flexapi#style(0, 'itemRenderer', 'mx.core.IFactory'),
  \ flexapi#style(1, 'kerning', 'Boolean'),
  \ flexapi#style(0, 'labelPosition', 'String'),
  \ flexapi#style(0, 'left', 'String'),
  \ flexapi#style(1, 'letterSpacing', 'Number'),
  \ flexapi#style(0, 'radialStroke', 'mx.graphics.IStroke'),
  \ flexapi#style(0, 'renderDirection', 'String'),
  \ flexapi#style(0, 'right', 'String'),
  \ flexapi#style(1, 'textAlign', 'String'),
  \ flexapi#style(1, 'textDecoration', 'String'),
  \ flexapi#style(1, 'textIndent', 'Number Length'),
